...
import { motion, AnimatePresence } from 'framer-motion'; // Corregido aquí
...
export default function App() {
  ...
  return (
    <div 
      ...
      className={`relative min-h-screen w-full flex items-center justify-center bg-black selection:bg-pink-500/30 ${stage === 'console' && consoleFinished ? 'cursor-pointer' : ''}`}
    >
      {/* Overlay opcional para efecto visual */}
      ...
      <AnimatePresence mode="wait">
        {stage === 'console' ? (
              ...
              {consoleFinished && (
                ...
                >
                  ...
                  <button
                    ...
                    className="group flex items-center gap-3 px-6 py-3 border border-pink-500/30 bg-pink-500/5 hover:bg-pink-500/10 text-pink-400 transition-all duration-300 pointer-events-auto"
                  >
          ...
          >
            ...
            >
              <h2 className="text-pink-500 font-mono text-xl tracking-[0.3em] uppercase mb-2 drop-shadow-[0_0_10px_rgba(236,72,153,0.5)]">
                Decrypted
              </h2>
